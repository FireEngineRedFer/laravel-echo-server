...
var PrivateChannel = (function () {
    ...
    PrivateChannel.prototype.authenticate = function (socket, data) {
        var headers = (data.auth && data.auth.headers) ? data.auth.headers : {};
        var referer = socket.request.headers.referer || headers.referer || '';
        var options = {
            url: this.authHost(referer) + this.options.authEndpoint,
    ...
    PrivateChannel.prototype.authHost = function (referer) {
